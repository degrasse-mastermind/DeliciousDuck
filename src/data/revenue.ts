...
export const DEEP_LINKS: DeepLinkEntry[] = [
  ...
  },
  {
    ...
    name: "Frozen duck from a mainstream retailer",
    useCase: "Reader wants duck without placing a specialty order",
    directUrl: "https://wildforkfoods.com/",
    status: "category-placeholder",
    lastVerified: "2026-08-18",
    editorialRelationship: "/buy/where-to-buy-duck-online (mainstream option)",
    handsOn: "untested",
    note: "Direct and unpaid. Duck range varies by location and season, so no cut-level or stock claim is published.",
  },
  {
    id: "sourcing-meat-n-bone",
    merchantId: "meat-n-bone",
    name: "Duck sourcing — affiliate application candidate",
    useCase: "Internal: the strongest near-term affiliate application for duck sourcing",
    directUrl: "https://meatnbone.com/",
    status: "category-placeholder",
    lastVerified: "2026-08-18",
    editorialRelationship: "Not placed on any public page yet",
    handsOn: "untested",
    note: "Public affiliate program via Shopify and Rakuten Advertising (advertiser ID 47482). Duck inventory looked thin or sold out at the 2026-08-18 review, so they are not featured editorially. Next action is filing an application, not a placement.",
  },
  {
