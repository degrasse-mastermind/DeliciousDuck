          ...
          sections={[
            {
              ...
              paragraphs: [
                ...
                "Many restaurants and classic French preparations serve duck breast pink, pulling it around 130–135°F (54–57°C). That is a culinary convention and it departs from USDA guidance — it is below the recommended safe minimum, so it carries greater food-safety risk than cooking to the USDA-recommended minimum. The two are not equally safe, and duck is poultry, so the reasoning people apply to rare steak does not transfer. If you cook breast pink anyway, understand the tradeoff, and do not serve it to young children, older adults, pregnant people, or anyone immunocompromised.",
            ...
            },
            {
              ...
              paragraphs: [
                ...
                "Store raw duck in the coldest part of the refrigerator and cook or freeze it within a day or two; refrigerate cooked duck within two hours and use it within three to four days, reheating leftovers to 165°F (74°C). Strain rendered fat into a clean sealed container and refrigerate it promptly; freeze it for longer storage. Discard it if it shows signs of spoilage.",
