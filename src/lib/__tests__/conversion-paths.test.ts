  ...
  it("documents the placement map: source, destination, intent, placement id", () => {
    ...
    expect(map).toMatchInlineSnapshot(`
      [
        ...
        "/buy/where-to-buy-duck-breast-online -> /recipes/pan-seared-duck-breast [technique_validation] #breast_sourcing_to_pan_seared_recipe",
        "/buy/where-to-buy-duck-breast-online -> /cook/how-to-cook-duck-breast [technique_validation] #breast_sourcing_to_breast_method",
        "/buy/where-to-buy-duck-breast-online -> /learn/duck-breast-temperature-doneness [temperature_verification] #breast_sourcing_to_doneness",
        "/buy/where-to-buy-duck-breast-online -> /gear/best-pan-for-duck-breast [equipment] #breast_sourcing_to_pan_guide",
        "/buy/where-to-buy-duck-breast-online -> /gear/best-thermometer-for-duck [equipment] #breast_sourcing_to_thermometer_guide",
        "/cook/how-to-cook-duck-breast -> /buy/where-to-buy-duck-breast-online [sourcing] #cook_breast_to_breast_sourcing",
        "/learn/duck-breast-temperature-doneness -> /buy/where-to-buy-duck-breast-online [sourcing] #breast_doneness_to_breast_sourcing",
