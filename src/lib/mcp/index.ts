...
export default defineMcp({
  ...
  // These tools declare no outputSchema; the SDK's type treats that optional
  // property as required under exactOptionalPropertyTypes.
  tools: [searchDuckContent, listDuckContent, getDuckRecipe] as unknown as McpDefinitionInput["tools"],
});
